package com.example.demo.jgroups.execution;
...
public class ExecutionServiceDemo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        ExecutionServiceDemo demo = new ExecutionServiceDemo(props, name, Integer.parseInt(size));
        demo.start();
    }
    ...
    protected static class ByteBufferStreamable implements Streamable {
        ...
        public ByteBufferStreamable(ByteBuffer buffer) {
            this.buffer = buffer;
        }
    ...
    public static class SortingByteCallable implements Callable<ByteBufferStreamable>, Streamable {
        ...
        public SortingByteCallable(byte[] numbers, int i, int size) {
            buffer = ByteBuffer.wrap(numbers, i, size);
        }
    ...
    protected static class SortingTwoByteCallable implements Callable<ByteBufferStreamable>, Streamable {
        ...
        @Override
        public ByteBufferStreamable call() throws Exception {
            ByteBuffer results = ByteBuffer.allocate(bytes1.remaining() + bytes2.remaining());
